...
import com.example.a47057.clweather.gson.Forecast;
import com.example.a47057.clweather.gson.Weather;
...
public class WeatherActivity extends MyActivity {
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "https://free-api.heweather.net/s6/weather?location=" +
                weatherId + "&key=7b42fa458dbc4001bc2d4d23cb3d9b6a";
        HttpUtils.sendOKHttpRequest
                (weatherUrl, new Callback() {
                    @Override
                    public void onResponse(Call call, Response response) throws IOException {
